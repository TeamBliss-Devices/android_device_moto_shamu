...
public class KeyHandler implements DeviceKeyHandler {
    ...
    // Supported scancodes
    private static final int SWEEP_UP = 4;
    private static final int SWEEP_DOWN = 8;
    private static final int SWEEP_LEFT = 2;
    private static final int SWEEP_RIGHT = 1;
    private static final int DOUBLETAP = 16;
    ...
    public boolean handleKeyEvent(KeyEvent event) {
        ...
        if (isKeySupported && !mEventHandler.hasMessages(GESTURE_REQUEST)) {
            ...
            if (mProximitySensor != null) {
                mEventHandler.sendMessageDelayed(msg, scanCode == DOUBLETAP ? 400 : 200);
                processEvent(event);
            } else {
